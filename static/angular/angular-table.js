...
//        tr.remove();
  ...
  pagination_template = "<div style='margin: 0px;'> <ul class='pagination'> <li ng-class='{disabled: get_current_page() <= 0}'> <a class='fa fa-angle-double-left' href='' ng-click='step_page(-" + irk_number_of_pages + ")'></a> </li> <li ng-class='{disabled: get_current_page() <= 0}'> <a class='fa fa-angle-left' href='' ng-click='step_page(-1)'></a> </li> <li ng-class='{active: get_current_page() == page}' ng-repeat='page in page_sequence.data'> <a  href='' ng-click='go_to_page(page)'>{{page + 1}}</a> </li> <li ng-class='{disabled: get_current_page() >= " + irk_number_of_pages + " - 1}'> <a class='fa fa-angle-right' href='' ng-click='step_page(1)'></a> </li> <li ng-class='{disabled: get_current_page() >= " + irk_number_of_pages + " - 1}'> <a class='fa fa-angle-double-right' href='' ng-click='step_page(" + irk_number_of_pages + ")'></a> </li> </ul> </div>";
